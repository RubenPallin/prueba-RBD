...
INSERT INTO tPersona (dni, nombre, correo,password, Pago, direccion, telefono,session_token) VALUES ('54701531Q', 'John Smith', 'johnsmith@example.com',"1234", 30, '123 Main St', 5555551," ");
INSERT INTO tPersona (dni, nombre, correo,password, Pago, direccion, telefono,session_token)  VALUES ("54701532Q", 'Jane Doe', 'janedoe@example.com', 30,"1234", '456 Park Ave',5555552," ");
INSERT INTO tPersona (dni, nombre, correo,password, Pago, direccion, telefono,session_token)  VALUES ("54701533Q", 'Bob Johnson', 'bobjohnson@example.com',"1234", 30, '789 Elm St', 5555553," ");
INSERT INTO tPersona (dni, nombre, correo,password, Pago, direccion, telefono,session_token)  VALUES ("54701534Q", 'Amy Miller', 'amymiller@example.com',"1234", 28, '321 Oak St', 5555554," ");
INSERT INTO tPersona (dni, nombre, correo,password, Pago, direccion, telefono,session_token)  VALUES ("54701535Q", 'Mark Wilson', 'markwilson@example.com',"1234", 28,'654 Pine St', 5555555," ");
